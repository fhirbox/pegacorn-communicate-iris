 ...
 */
package net.fhirbox.pegacorn.communicate.iris.transformers;
...
public class TransformErrorException extends Exception {
     ...
     */
    public TransformErrorException(String msg) {
        super(msg);
    }    
     ...
     * @param msg the detail message.
     */
    public TransformErrorException(String msg, Throwable cause) {
        super(msg, cause);
    }
}
