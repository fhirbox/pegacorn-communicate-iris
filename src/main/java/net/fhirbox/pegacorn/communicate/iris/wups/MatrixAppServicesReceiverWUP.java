...
@ApplicationScoped
public class MatrixAppServicesReceiverWUP extends RouteBuilder {
    private static final Logger LOG = LoggerFactory.getLogger(MatrixAppServicesReceiverWUP.class);
